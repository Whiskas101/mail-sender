# I also hate moving files. I am lazy.
# This module is essentially a version of the snipping tool (win + shift + s )
# Except it looks much worse 👍
# (Function over form!)
...
class Application():
    def __init__(self, master, targetDir):
    ...
    def create_screen_canvas(self):
        ...
        self.snip_surface = Canvas(self.picture_frame, cursor="cross", bg="grey10")
    ...
    def take_bounded_screenshot(self, x1, y1, x2, y2):
        ...
        image.save(self.targetDir+ "/" + file_name + ".png")
